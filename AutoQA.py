...
def start_browsertest(project_name, url, test_case, mode, method, browserlist, resollist, video):
    ...
    for browser in browserlist :
        ...
        driver = auto.crossbrowser(url, browser)
                    ...
                    if mode == 'all' :# скрин после каждого действия
                        ...
                        if method == 'url' :
                            if stand_url != cur_url:
                                ...
                                name_of_mockup = 'Etalon\\'+ browser + '\\' + str(resolution) + '\\screenshot' + str(file_index) + '.png'
    ...
    if mode == 'etalon' : # Удаление старой парки Эталон и копирование в неё этелонов
...
def start_browtest():
    ...
    text_info.see(END)
    start_browsertest(input_project.get(), input_url.get(), test_case, mode.get(), method.get(), browserlist, resollist, video)
    
brow_title = Label(frame_brow, text = "Тестирование web-приложения",
                   font = 'Arial 12 bold')
...
nb.add(frame_brow, text = ' Web-тестирование ')
...
lab_browser.grid(row = 14, column = 1, sticky=W+E, padx = 10, pady = 10)#browsers
cb1.grid(row = 15, column = 1, sticky=W, padx = 15)
cb2.grid(row = 16, column = 1, sticky=W, padx = 15)
cb3.grid(row = 17, column = 1, sticky=W, padx = 15)
cb4.grid(row = 18, column = 1, sticky=W, padx = 15)
cr1.grid(row = 15, column = 0, sticky=W)
cr2.grid(row = 16, column = 0, sticky=W)
cr3.grid(row = 17, column = 0, sticky=W)
cr4.grid(row = 18, column = 0, sticky=W)
cr5.grid(row = 19, column = 0, sticky=W)
